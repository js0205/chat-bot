...
const Chatbot = ({ port }) => {
  ...
  const onhandleFinished = async () => {
    ...
    try {
      ...
      localStorage.setItem('spiceBot', JSON.stringify(newMessages));
  ...
  useEffect(() => {
    const initMessages = localStorage.getItem('spiceBot');
    if (!!initMessages) {
      try {
    ...
    <div className='chat-bot'>
      {!messages.length && (
        <div className='chat-bot-empty'>
          <div className='chat-bot-title'>你好，我是SPICE大模型</div>
